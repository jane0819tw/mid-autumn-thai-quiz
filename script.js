...
const CONFIG = {
  ...
  results: {
    burnt: {
      ...
      copy: '我的泰文實力就像烤焦的肉片……黑成一片、看不出原形！不過別灰心，刮掉焦的那層還是能吃，從基礎重新打底就救得回來。',
      products: [
        {
          name: '漢泰小詞典',
          url: 'https://thaiskr.com/store/products/BB_0001',
          image: 'images/BB_0001.jpg',
          desc: '用中文就能查泰文的小詞典，輕巧好翻。想知道「月餅」「柚子」泰文怎麼說，翻開就找得到，是零基礎最實用的第一本工具書。',
        },
        {
          name: '1000個給小孩的中文單字書籍',
          url: 'https://thaiskr.com/store/products/BB_0005',
          image: 'images/BB_0005.jpg',
          desc: '1000 個生活單字搭配可愛插圖與中泰對照，看圖就能記單字。給小孩的編排一點壓力也沒有，最適合從零開始的大人。',
        },
        {
          name: '[中]從電影學泰語句型手札',
      ...
      products: [
        {
          ...
          desc: '收錄 1000 句生活化的泰語會話，從打招呼、點餐到聊天抬槓都有。把你學過的單字串成真正開得了口的句子。',
        },
        {
          name: '用中文問答系列',
          url: 'https://thaiskr.com/store/products/BB_0007',
          image: 'images/BB_0007.jpg',
          desc: '用熟悉的中文提問、用泰文回答的問答式編排。一問一答反覆練習，日常對話的句型自然就記住了。',
        },
      ],
    },
    full: {
